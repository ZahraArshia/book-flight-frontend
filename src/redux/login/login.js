...
export const LOGIN_SUCCESS = 'BOOKING_FLIGHT/LOGIN_SUCCESS';
export const LOGIN_FAILURE = 'BOOKING_FLIGHT/LOGIN_FAILURE';
export const LOGOUT_SUCCESS = 'BOOKING_FLIGHT/LOGOUT_SUCCESS';
export const LOGOUT_FAILURE = 'BOOKING_FLIGHT/LOGOUT_FAILURE';

export const IS_LOGIN = 'BOOKING_FLIGHT/IS_LOGIN';
